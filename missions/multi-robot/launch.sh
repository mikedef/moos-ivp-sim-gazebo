...
nsplug meta_asset2.moos targ_"$VNAME2".moos -f WARP=$TIME_WARP       \
   VNAME=$VNAME2   VPORT="9002"         GPORT="9502"                      \
   VTYPE="ship"    SHARE_LISTEN="9302"                        \
...
nsplug meta_asset2.bhv targ_$VNAME2.bhv -f VNAME=$VNAME2 
